...
public class ActiveDirectoryAuthentication {
	...
	public void setActiveDirectoryAuthentication(String asValue) {
		domainName = asValue.toUpperCase();
...
//			boolean authResult = authentication.authenticate("annop.th", "astro@@8");
